...
function generateDocsMd(): string {
  ...
  lines.push('```')
  lines.push('')
  lines.push('If no server owns your directory, `hj` falls back to the shared default port')
...
function generateLlmsTxt(): string {
  ...
  lines.push('  port a shell targets and WHY; override with `--port` or `--name`.')
